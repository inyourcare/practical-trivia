      ...
      >
        <div className="w-full flex p-3 flex-col md:flex-row">
          ...
          <div className="flex-1 p-3">
            ...
            <p className={`${styles.subText} mb-2`}>{`그리고 그런 그에게 이제는 꿈이 생겼습니다. 그가 겪은 어려움을 그 다음 세대는 겪지 않았으면 좋겠다고 생각합니다. 살기 위해 일하는 것이 아니라 목표를 이루기 위해 살아갑니다. 내면의 출구를 향한 걸음을 끝내고, 세상을 향한 걸음을 나아가 보려합니다. 그 첫걸음.`}</p>
          </div>
        </div>
