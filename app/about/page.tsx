      ...
      >
        <div className="w-full flex p-3">
          ...
          <div className="flex-1 p-3">
            ...
            <p className={`${styles.subText} mb-2`}>{`실용주의 잡학사전은 대한민국의 대구라는 도시에서 태어났습니다. 그는 삶에 모순이 많다고 생각했습니다. 의문은 늘어났지만 해답을 찾을수는 없었습니다.`}</p>
            <p className={`${styles.subText} mb-2`}>{`허무함에 빠져 핑계로 가득찬 하루하루를 보내던 그는 어느날, 차분히 한걸음씩 걸어 가 보면 어떨까라는 생각을 합니다. 삶에대한 태도, 가치관, 버릇, 습관. 보이는 하나하나 차근차근 개선 해 나갑니다.`}</p>
            <p className={`${styles.subText} mb-2`}>{`그리고 그런 그에게 이제는 꿈이 생겼습니다. 그가 겪은 어려움을 그 다음 세대는 겪지 않았으면 좋겠다고 생각합니다. 살기 위해 일하는 것이 아니라 목표를 이루기 위해 살아갑니다. 이제까지 내면의 출구를 향한 걸음을 끝내고, 세상을 향한 걸음을 나아가 보려합니다. 그 첫걸음.`}</p>
          </div>
        </div>
